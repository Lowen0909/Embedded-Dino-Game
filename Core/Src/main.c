...
int main(void)
{
  ...
  MX_SPI2_Init();
  /* USER CODE BEGIN 2 */
  myAccConfigDef.dataRate = LIS3DSH_DATARATE_100;
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : ex_squat_btn_Pin */
  GPIO_InitStruct.Pin = ex_squat_btn_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(ex_squat_btn_GPIO_Port, &GPIO_InitStruct);
